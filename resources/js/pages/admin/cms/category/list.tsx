...
export default function ListPage() {
    ...
    const fetchData = useCallback(async () => {
        ...
        setIsLoading(true);
        try {
            const response = await axios.get(categories.data().url, {
                params: {
    ...
    const columns = useMemo(
        () => [
            ...
            {
                header: (info: any) => renderRowHeader(info, 'Parent'),
                accessorKey: 'parent.name',
                accessorFn: (row: any) => row.parent?.name ?? '-',
            },
            {
                header: (info: any) => renderRowHeader(info, 'Posts'),
                accessorKey: 'posts_count',
                accessorFn: (row: any) => row.posts.length,
            },
            {
